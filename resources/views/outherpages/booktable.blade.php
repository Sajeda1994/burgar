                            ...
                            <div class="row">
                                <div class="col-md-7 col-lg-6 ">
                                    <div class="detail-box">
                                        ...
                                        <p>
                                            {{__('trans.In our restaurant we serve fast and delicious food, as we have different meals from
                                         delicious burgers with French cheese. For more, browse the meals from here..')}}
                                        </p>
                                        <div class="btn-box">
                                            <a href="" class="btn1">
                            ...
                            <div class="row">
                                <div class="col-md-7 col-lg-6 ">
                                    <div class="detail-box">
                                        ...
                                        <p>
                                            {{__('trans.In our restaurant we serve fast and delicious food, as we have different meals from
                                         delicious pasta with meat and cheese. For more, browse the meals from here..')}}
                            ...
                            <div class="row">
                                <div class="col-md-7 col-lg-6 ">
                                    <div class="detail-box">
                                        ...
                                        <p>
                                            {{__('trans.In our restaurant we serve fast and delicious food as we have different
                                         and delicious appetizersFor more browse the appetizers from here')}}
