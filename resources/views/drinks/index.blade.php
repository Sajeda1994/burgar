...
<div class="row">
    <div class="col-7 m-2">
        <button class="btn btn-warning " data-target="#adddrinks" data-toggle="modal">{{__('trans.Add Drink')}}</button>
    </div>
    <div class="col-5">
        @if ($errors->any())
        ...
        <tbody class="bg-info">
            ...
            @foreach ($drinks as $drink)
                ...
                <tr>
                    ...
                    <td><img src="{{'\drinkphoto\thumb'.$drink->image}}" width="50px" height="50px" alt="" srcset=""></td>
                    <td>
                        <button class="btn btn-warning" data-target="#editappet-{{$drink->id}}" data-toggle="modal">{{__('trans.Edit')}}</button>
                        <button class="btn btn-warning" data-target="#deleteappet-{{$drink->id}}" data-toggle="modal">{{__('trans.Delete')}}</button>
                    </td>
                    @include('drinks.update')
                    @include('drinks.delete')
                </tr>
...
<div class="modal fade" id="adddrinks" tabindex="-1" role="dialog" aria-labelledby="verticalModalTitle"
    aria-hidden="true">
